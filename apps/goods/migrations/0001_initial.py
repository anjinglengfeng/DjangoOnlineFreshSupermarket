    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_brief', models.TextField(help_text='简短描述', max_length=500, verbose_name='简短描述')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_type', models.SmallIntegerField(choices=[(1, '一级类目'), (2, '二级类目'), (3, '三级类目')], default=1, help_text='类目级别', verbose_name='类目级别')),
                ('is_tab', models.BooleanField(default=False, help_text='类目是否导航', verbose_name='是否导航')),
                ('add_time', models.DateTimeField(auto_now_add=True, verbose_name='添加时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(auto_now_add=True, verbose_name='添加时间')),
                ('category', models.ForeignKey(blank=True, help_text='商品类别', null=True, on_delete=django.db.models.deletion.CASCADE, to='goods.GoodsCategory', verbose_name='商品类别')),
            ],
            options={
                'verbose_name': '品牌',
