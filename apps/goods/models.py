...
class GoodsCategory(models.Model):
    ...
    category_type = models.SmallIntegerField(choices=CATEGORY_TYPE, default=1, verbose_name='类目级别', help_text='类目级别')
    is_tab = models.BooleanField(default=False, verbose_name='是否导航', help_text='类目是否导航')
...
class Goods(models.Model):
    ...
    goods_brief = models.TextField(max_length=500, verbose_name='简短描述', help_text='简短描述')
