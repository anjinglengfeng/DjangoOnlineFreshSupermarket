    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('success', '成功'), ('cancle', '取消'), ('topaid', '待支付')], help_text='订单状态', max_length=20, verbose_name='订单状态')),
                ('post_script', models.CharField(blank=True, help_text='订单留言', max_length=50, null=True, verbose_name='定案留言')),
                ...
                ('singer_mobile', models.CharField(help_text='联系电话', max_length=11, verbose_name='联系电话')),
                ('add_time', models.DateTimeField(auto_now_add=True, verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '订单',
